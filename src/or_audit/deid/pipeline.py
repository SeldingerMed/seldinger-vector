...
from or_audit.deid.writer import FrameWriter
...
from or_audit.media.frames import FrameSource
...
def redact(
    ...
    *,
    ...
    Raises:
        DeidentificationBoundaryError: If the asset is already settled.
    """
    _reject_settled(asset)
